...
export const Timer = () => {
    ...
    let hours = ("0" + today.current.getHours()).slice(-2);
    let minutes =  ':' + ("0" + today.current.getMinutes()).slice(-2) ;
    let seconds = ':' + ("0" + today.current.getSeconds()).slice(-2);
    ...
    useEffect(() => {
        setTimeout(() => {
            ...
            refreshToday();
            setTime(("0" + today.current.getHours()).slice(-2) + ':' + ("0" + today.current.getMinutes()).slice(-2) + ':' + ("0" + (today.current.getSeconds())).slice(-2));
        }, 1000);
